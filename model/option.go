...
func InitOptionMap() {
	...
	common.OptionMap["QuotaForInviterRechargeRatio"] = strconv.FormatFloat(common.QuotaForInviterRechargeRatio, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "QuotaForInviterRechargeRatio":
		common.QuotaForInviterRechargeRatio, _ = strconv.ParseFloat(value, 64)
