...
- 比例：`9:16`、`16:9`、`1:1`
- 分辨率：固定 `480p`
- 尺寸映射：`9:16` = `496x864`，`16:9` = `864x496`，`1:1` = `640x640`，`21:9` = `992x432`，`4:3` = `752x560`，`3:4` = `560x752`
...
| `size` | string | 否 | 直接指定输出尺寸，如 `1280x720`、`1470x630`、`1112x834` |
| `aspect_ratio` | string | 否 | 视频比例，支持 `16:9`、`9:16`、`1:1`、`21:9`、`4:3`、`3:4` |
...
- `720p` 尺寸映射：`16:9` = `1280x720`，`9:16` = `720x1280`，`1:1` = `960x960`，`21:9` = `1470x630`，`4:3` = `1112x834`，`3:4` = `834x1112`。
- `480p` 尺寸映射：`16:9` = `864x496`，`9:16` = `496x864`，`1:1` = `640x640`，`21:9` = `992x432`，`4:3` = `752x560`，`3:4` = `560x752`。
